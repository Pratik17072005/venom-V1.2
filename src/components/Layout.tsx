  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-0 z-40 lg:hidden ${sidebarOpen ? '' : 'pointer-events-none'}`}>
        ...
        />
        <div 
          className={`fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl transition-transform transform ${
        ...
        >
          <div className="flex h-16 items-center justify-between px-6 bg-primary-600">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">ConstructPro</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
